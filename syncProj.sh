...
cp "$MINI_HTTP_AUTOMATION_SOURCE" "$SCRIPT_DIR/WGacShared/MiniHttpAutomationService.cpp"
cp "$REMOTE_RENDERER_SOURCE" "$SCRIPT_DIR/RemotingTest_Renderer_Wayland/GuiMain.cpp"
echo "Synchronized MiniHTTP automation and Wayland native remote renderer sources."
